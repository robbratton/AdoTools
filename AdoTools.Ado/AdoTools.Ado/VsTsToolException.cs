...
namespace Upmc.DevTools.VsTs
{
    ...
    /// </summary>
    [Serializable]
    public class VsTsToolException : Exception
    {
        /// <inheritdoc />
        public VsTsToolException()
        {
        }
        ...
        public VsTsToolException(string message) : base(message)
        {
        }
        ...
        /// </param>
        public VsTsToolException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        /// </exception>
        protected VsTsToolException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}