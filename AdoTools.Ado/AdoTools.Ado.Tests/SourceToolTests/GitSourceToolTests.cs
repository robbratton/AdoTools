...
namespace Upmc.DevTools.VsTs.Tests.SourceToolTests
{
    ...
    public class GitSourceToolTests
    {
            ...
            Parallel.ForEach(items, (item, state, index) =>
                {
                    ...
                    // Act
                    var result = sourceTool.GetBranches("Upmc.DevTools.VsTs");
        ...
        public static void GetCommits_Succeeds_Nulls()
        {
            ...
            var result = sourceTool.GetCommits("Upmc.DevTools.Vsts", "develop");
        ...
        public static void GetCommits_Succeeds_One()
        {
            ...
            var result = sourceTool.GetCommits("Upmc.DevTools.Vsts", "develop", 0, 1);
        ...
        public static void GetCommits_Throws_WithBadBranch()
        {
            ...
            Assert.That(
                ...
                () => sourceTool.GetCommits("Upmc.DevTools.Vsts", "SnaggleTooth"),
