    ...
    public class SolutionParserTests
    {
        ...
        public void ParseSolutionFileContent_ReturnsExpectedResult()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(project1.NameInSolution, Is.EqualTo("AdoTools.CsProject"), "project1.NameInSolution");
                Assert.That(
                    project1.PathRelativeToSolution,
                    Is.EqualTo(@"AdoTools.CsProject\AdoTools.CsProject.csproj"),
                    "project1.PathRelativeToSolution");
                ...
                Assert.That(
                    ...
                    Is.EqualTo("AdoTools.CsProject.Tests"),
                    "project2.NameInSolution");
                Assert.That(
                    project2.PathRelativeToSolution,
                    Is.EqualTo(@"AdoTools.CsProject.Tests\AdoTools.CsProject.Tests.csproj"),
                    project2.PathRelativeToSolution);
